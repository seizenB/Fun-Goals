...
public class DanaPensiun extends VBox {
    ...
    public DanaPensiun() {
        ...
        vBox.getChildren().addAll(pengeluaran, hBox1, pengeluaranPerTahun, hBox2, usia, hBox3, usia2, hBox4, inflasi, hBox5, pengeluaranpensiun, hBox6);
        ...
        nextButton.setOnAction(event -> {
            ...
            vBox.getChildren().addAll(pemasukan, hBox7, dana, hBox8, target, hBox9, targetReturn, hBox10, pensiun, hBox11);
